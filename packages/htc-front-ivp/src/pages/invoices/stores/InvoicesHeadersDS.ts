  ...
  return {
    ...
    queryDataSet: new DataSet({
      ...
      fields: [
        ...
        {
          name: 'taxpayerNumber',
          label: intl.get(`${modelCode}.view.taxpayerNumber`).d('公司代码'),
          type: FieldType.string,
        ...
        {
          name: 'checkDateFrom',
          label: intl.get(`${modelCode}.view.checkDateFrom`).d('勾选日期从'),
          type: FieldType.date,
          max: 'checkDateTo',
          required: true,
          defaultValue: yearStart,
        ...
        {
          name: 'checkDateTo',
          label: intl.get(`${modelCode}.view.checkDateTo`).d('勾选日期至'),
          type: FieldType.date,
          min: 'checkDateFrom',
          required: true,
          defaultValue: moment().format(DEFAULT_DATE_FORMAT),
        ...
        {
          name: 'checkStates',
          label: intl.get(`${modelCode}.view.checkStates`).d('勾选状态'),
          type: FieldType.string,
          lookupCode: 'HIVP.CHECK_STATE',
          multiple: ',',
        },
