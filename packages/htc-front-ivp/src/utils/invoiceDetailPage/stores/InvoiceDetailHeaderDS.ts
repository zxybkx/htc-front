...
export default (propsData): DataSetProps => {
  ...
  const OPurl = `${IVP_PREFIX}/v1/${tenantId}/invoice-header-infos/query-invoice-all-info/${propsData.invoiceHeaderId}`;
  const SAASurl = `${CHAN_API}/v1/${tenantId}/invoice-header-infos/query-invoice-all-info/${propsData.invoiceHeaderId}`;
