  ...
  return {
    ...
    fields: [
      ...
      },
      {
        ...
        label: intl.get('hmdm.tenantAgreement.view.registrationCode').d('客户注册代码'),
        type: FieldType.string,
      },
      {
        name: 'companyObject',
      ...
      },
      {
        ...
        label: intl.get('hmdm.tenantAgreement.view.enterpriseAlipayAccount').d('企业支付宝账号'),
        type: FieldType.string,
      },
      {
        name: 'checkChannelCode',
        label: intl.get('hmdm.tenantAgreement.view.checkChannelCode').d('查验通道接口'),
        type: FieldType.string,
        required: true,
      ...
      },
      {
        ...
        label: intl.get('hmdm.tenantAgreement.view.authorizationCode').d('航信企业授权码'),
        type: FieldType.string,
        required: true,
      },
      {
        name: 'currentToken',
        label: intl.get('hmdm.tenantAgreement.view.currentToken').d('当前TOKEN'),
        type: FieldType.string,
      },
      {
        name: 'tokenGenerationDate',
        label: intl.get('hmdm.tenantAgreement.view.tokenGenerationDate').d('TOKEN生成时间'),
        type: FieldType.dateTime,
      },
      {
        name: 'authorizationOutputCode',
        label: intl
          .get('hmdm.tenantAgreement.view.authorizationOutputCode')
          .d('航信企业销项授权码'),
        type: FieldType.string,
      },
      {
      ...
      },
      {
        ...
        label: intl.get('hmdm.tenantAgreement.view.preferOcrChannelCode').d('首选OCR通道'),
        type: FieldType.string,
        lookupCode: 'HMDM.PREFER_OCR_CHANNEL',
      },
      {
        name: 'retryOcrChannelCode',
        label: intl.get('hmdm.tenantAgreement.view.retryOcrChannelCode').d('重试OCR通道'),
        type: FieldType.string,
        lookupCode: 'HMDM.RETRY_OCR_CHANNEL',
      },
      {
        name: 'accountNumber',
        label: intl.get('hmdm.tenantAgreement.view.accountNumber').d('账号'),
        type: FieldType.string,
      },
      {
        name: 'ocrPassword',
      ...
      },
      {
        ...
        label: intl.get('hmdm.tenantAgreement.view.outChannelModeCode').d('销项服务方式'),
        type: FieldType.string,
        computedProps: {
